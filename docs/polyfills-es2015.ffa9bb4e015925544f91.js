    ...
    pDpN: function (e, t) {
      !(function (e) {
        ...
        class s {
          ...
          runTask(e, t, n) {
            if (e.zone != this)
              throw new Error(
                'A task can only be run in the zone of creation! (Creation: ' + (e.zone || m).name + '; Execution: ' + this.name + ')'
              );
          ...
          cancelTask(e) {
            if (e.zone != this)
              throw new Error(
                'A task can only be cancelled in the zone of creation! (Creation: ' + (e.zone || m).name + '; Execution: ' + this.name + ')'
              );
        ...
        class a {
          ...
          _updateTaskCount(e, t) {
            ...
            (0 != o && 0 != r) ||
              this.hasTask(this.zone, { microTask: n.microTask > 0, macroTask: n.macroTask > 0, eventTask: n.eventTask > 0, change: e });
          }
        }
        class c {
          ...
          _transitionTo(e, t, n) {
            if (this._state !== t && this._state !== n)
              throw new Error(
                `${this.type} '${this.source}': can not transition to '${e}', expecting state '${t}'${n ? " or '" + n + "'" : ''}, was '${
                  this._state
                }'.`
              );
        ...
        Zone.__load_patch('ZoneAwarePromise', (e, t, n) => {
          ...
          function v(e, o, s) {
            ...
            if (null === e[d]) {
              ...
              if (!1 !== o && s instanceof Z && s.hasOwnProperty(d) && s.hasOwnProperty(g) && null !== s[d]) w(s), v(e, s[d], s[g]);
      ...
      function Y(e, t, n) {
        return (
          ...
          n.configurable || (e[V] || Object.isFrozen(e) || $(e, V, { writable: !0, value: {} }), e[V] && (e[V][t] = !0)),
          n
        );
      }
      function K(e, t, n, o) {
            ...
            function (r, s) {
              if ('function' == typeof s[0]) {
                const e = u(
                  t,
                  s[0],
                  { isPeriodic: 'Interval' === o, delay: 'Timeout' === o || 'Interval' === o ? s[1] || 0 : void 0, args: s },
                  a,
                  c
                );
                if (!e) return e;
